/*
 * opencog/embodiment/Control/MessagingSystem/RawMessage.h
 *
...
public:
    ...
    ~RawMessage();
    RawMessage(const std::string &from, const std::string &to);
    RawMessage(const std::string &from, const std::string &to, const std::string &msg);
    RawMessage(const std::string &from, const std::string &to, const char *msg);
