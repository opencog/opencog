...
class RewardMessage : public MessagingSystem::Message {
	...
	public:
        ...
        void setSchemaArguments(const std::vector<std::string> & schemaArgs) { this->schemaArguments = schemaArgs;};
        const std::vector<std::string> getSchemaArguments() { return schemaArguments; };
