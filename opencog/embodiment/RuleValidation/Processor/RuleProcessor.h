    ...
    public:
        ...
        class Action : public std::pair<std::string, std::vector<std::string> > {
            ...
            public:
                ...
                inline const std::string& getName( void ) const { return first; }
                inline void  setName( const std::string& name ) { first = name; }

                inline const std::vector<std::string>& getParameters( void ) const { return second; }
        ...
        class Relation {
            ...
            public:
                ...
                inline const float getIntensity( void ) const { return intensity; }
                inline const std::string& getTarget( void ) const { return target; }
        ...
        class Feeling : public std::pair<std::string, float> {
            ...
            public:
                ...
                inline const float getIntensity( void ) const { return second; }
                inline void  setIntensity( float intensity ) { second = intensity; }
