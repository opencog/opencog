                                                ...
                                                Handle obj1, Handle obj2)
{
    ...
    return false;
    /*
    if (pos1 == SpaceServer::SpaceMapPoint::ZERO ||
        pos2 == SpaceServer::SpaceMapPoint::ZERO ) {
...
#define getIncomingSet(iter,h,t,sub) h->getIncomingSetByType(iter,t,sub)
    ...
    for (Handle hSimilarityLink : similarityLinkSet) {
        timeServer().getTimeInfo( back_inserter(handleTemporalPairs), hSimilarityLink);
    }
                                           ...
                                           const Temporal& t)
{
    ...
    return addGenericPropertyPred(atomSpace, predicateName, ll_out, tv, permanent, t);
}
