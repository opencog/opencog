 ...
 *     homeostatic bounds.
 *
 * See http://www.opencog.org/wiki/MinMaxSTIUpdatingAgent
 *
 ...
 *
 * The MinMaxSTIUpdatingAgent takes this stimulus and pays wages to atoms. So
 * in a sense, the stimulus is a record of how much work the atom has been
 * involved in. The currency of the wages that the MinMaxSTIUpdatingAgent pays
 ...
 * MinMaxSTIUpdatingAgent uses to pay wages has to come from somewhere. In an
 ...
 * MinMaxSTIUpdatingAgent draws STI and LTI from a pool of funds managed by the
 * Atom Space. These pools have a homeostatic range that the
 * MinMaxSTIUpdatingAgent tries to keep the Atom Space funds within. If, at the
 ...
 * MinMaxSTIUpdatingAgent. Create a opencog::MindAgent function that converts stimulus
