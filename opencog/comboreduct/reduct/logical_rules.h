...
struct eval_logical_identities : public crule<eval_logical_identities> { 
    eval_logical_identities() : crule<eval_logical_identities>::crule("eval_logical_identities") {}
    void operator()(combo_tree& tr,combo_tree::iterator it) const;
};
...
struct reduce_and_assumptions : public crule<reduce_and_assumptions> {
    reduce_and_assumptions(const rule& r) : crule<reduce_and_assumptions>::crule("reduce_and_assumptions"), _reduction(&r) { }
    reduce_and_assumptions() : crule<reduce_and_assumptions>::crule("reduce_and_assumptions"), _reduction(this) { }
    void operator()(combo_tree& tr,combo_tree::iterator it) const;
protected:
...
struct reduce_or_assumptions : public crule<reduce_or_assumptions> {
    ...
    reduce_or_assumptions() : crule<reduce_or_assumptions>::crule("reduce_or_assumptions"), _reduction(this) { }
    void operator()(combo_tree& tr,combo_tree::iterator it) const;
protected:
    const rule* _reduction;
};
