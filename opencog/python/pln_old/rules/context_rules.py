...
Rule explanations can be found in
    ../../../reasoning/engine/rules/pln/contextualize.scm
    ../../../reasoning/engine/rules/pln/decontextualize.scm
    ../../../reasoning/engine/rules/pln/context-free-to-contextualize.scm
