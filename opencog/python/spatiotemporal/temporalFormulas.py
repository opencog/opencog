import temporal_interval_handling
...
#a- < b- and b- < a+ and a+ < b+
    ...
    return temporal_interval_handling.normalize(min((com_beg_2[0] - com_beg_1[0]) / (size_beg_2 + size_beg_1),
...
#b- < a- and a+ < b+
    ...
    return temporal_interval_handling.normalize(min((com_beg_1[0] - com_beg_2[0]) / (size_beg_1 + size_beg_2),
                                                    (com_end_2[0] - com_end_1[0]) / (size_end_2 + size_end_1)))
...
#a+ = b-
    ...
    return temporal_interval_handling.normalize(
        ((size_end_1 + size_beg_2) - abs(com_end_1[0] - com_beg_2[0])) / (size_end_1 + size_beg_2))
...
#a+ = b+ and b- < a-
    ...
    return temporal_interval_handling.normalize(
        min(((size_end_1 + size_end_2) - abs(com_end_1[0] - com_end_2[0])) / (size_end_1 + size_end_2),
