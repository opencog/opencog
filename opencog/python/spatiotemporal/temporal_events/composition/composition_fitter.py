...
class CompositionFitter(object):
    def __init__(self, data_a_b, data_b_c):
        ...
        self.parameters.add_many(
            ...
            ('A_beg_scale', 1.5, True, 0.0, None, None),
            ('delta_A', -1, True, None, 0.0, None),
            ('A_end_loc', 2, False, None, None, '(A_beg_loc + A_beg_scale) - delta_A'),
            ('A_end_scale', 1.5, True, 0.0, None, None),
            ('B_beg_loc', 0, False, None, None, None),
            ('B_beg_scale', 1, False, 0.0, None, None),
            ('delta_B', -1, True, None, 0.0, None),
            ('B_end_loc', 2, False, None, None, '(B_beg_loc + B_beg_scale) - delta_B'),
            ('B_end_scale', 4.5, True, 0.0, None, None),
            ('C_beg_loc', 0, True, None, None, None),
            ('C_beg_scale', 0.7, True, 0.0, None, None),
            ('delta_C', -1, True, None, 0.0, None),
            ('C_end_loc', 2, True, None, None, '(C_beg_loc + C_beg_scale) - delta_C'),
            ('C_end_scale', 0.7, True, 0.0, None, None)
        )

        minimize(self.fitness, self.parameters)
