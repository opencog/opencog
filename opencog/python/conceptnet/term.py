...
# This code reads word frequencies from a csv file, and
...
def read_frequencies(file_path, separator=',', type_of_corpus=0):
    container = []  # It is a list of lists.
    with open(file_path, 'r') as stream:
        # a list of list of word frequencies
        freq_list = csv.reader(stream, delimiter=separator)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print ("the term frequency and the total word frequency are ",
            str([corpus_dict["  " + term.upper()], twf]))
