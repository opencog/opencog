...
from pln.examples.tuffy.smokes import smokes_agent
...
# FILENAME = "/home/cosmo/test-datasets/pln/tuffy/smokes/smokes.scm"
#
# with open(FILENAME, 'r'):
#     scheme_wrapper.load_scm(atomspace, FILENAME)

#print('AtomSpace starting contents:')
#atomspace.print_list()

# Test multiple steps of forward inference on the AtomSpace
test_agent = smokes_agent.InferenceAgent()
for i in range(1, 500):
    result = test_agent.run(atomspace)
