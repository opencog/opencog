...
cat disjunct-list.scm    |netcat -q60 $HOST $PORT
cat stats-collection.scm |netcat -q60 $HOST $PORT
cat wsd-process.scm      |netcat -q60 $HOST $PORT
cat A.scm                |netcat -q60 $HOST $PORT
