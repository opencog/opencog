; Resolution psi-modulator definition
(InheritanceLink
    ; The strength of the stv is the stimulus level, & confidence is always 1.
    (ConceptNode "OpenPsi: Resolution" (stv 0.5 1))
    (ConceptNode "OpenPsi: Modulator")
)

; Stimuli that can act on the psi-modulator Resolution
(EvaluationLink
    ...
    (ListLink
        ...
        (ConceptNode "OpenPsi: Resolution")
    )
)
