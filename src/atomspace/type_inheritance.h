...
init_inheritance(map, ORDERED_LINK, PART_OF_LINK);
...
init_inheritance(map, LIST_LINK, SENTENCE_LINK);
...
init_inheritance(map, SET_LINK, LINK_GRAMMAR_LINKAGE_LINK);
init_inheritance(map, ASSOCIATIVE_LINK, WORD_SENSE_LINK);
init_inheritance(map, INHERITANCE_LINK, HOLONYM_LINK);
init_inheritance(map, SIMILARITY_LINK, PATH_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, HSO_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, LCH_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, LESK_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, LIN_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, JCN_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, RES_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, VECTOR_SIMILARITY_LINK);
init_inheritance(map, SIMILARITY_LINK, WUP_SIMILARITY_LINK);
