...
namespace Util {
  ...
  struct const_function {
    ...
    T operator()(U1) const { return _t; }
    template<typename U1,typename U2>
    T operator()(U1,U2) const { return _t; }
    template<typename U1,typename U2,typename U3>
    T operator()(U1,U2,U3) const { return _t; }
  private:
    T _t;
  };

  template<typename T>
  const_function<T> make_const_function(const T& t) { return const_function<T>(t); }
