...
class PetInterfaceMock: public Control::PetInterface {
    ...
    public:
        ...
        bool isExemplarInProgress() const { return exemplarInProgress; }
	...
	void setOwnerId(const string& _ownerId) { ownerId = _ownerId; }
	void setExemplarAvatarId(const string& _exemplarAvatarId) { exemplarAvatarId = _exemplarAvatarId; }
	const string& getOwnerId() const { return ownerId; }
	const string& getExemplarAvatarId() const { return exemplarAvatarId; }
	void setName(const string& _petName) { petName = _petName; }
	const string& getName() const { return petName; }
    ...
    bool isNear(const Handle& objectHandle) { return false; }
    bool getVicinityAtTime(unsigned long timestamp, HandleSeq& petVicinity) { return true; }
