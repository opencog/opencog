...
BuildRequires:  cmake >= 2.4.6, make >= 3, gcc-c++ >= 4.1, csockets-devel >= 2.2.9, libexpat-devel >= 2, boost-devel >= 1.34, unixODBC-devel >= 2.2, guile-devel >= 1.8.5, glibc-devel >= 2.3
...
Group:   Development/Libraries
Requires: opencog-server >= %{version}, libatomspace-devel >= %{version}, csockets-devel >= 2.2.9, openssl-devel >= 0.9.8, libexpat-devel >= 2
