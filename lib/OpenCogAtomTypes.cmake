...
FOREACH (LINE ${TYPE_SCRIPT_CONTENTS})
    ...
    IF (MATCHED AND CMAKE_MATCH_1)
        ...
        ELSE (NOT "${TYPE}" STREQUAL "NOTYPE")
            FILE(APPEND "${HEADER_FILE}" "extern const opencog::Type ${TYPE};\n")
            FILE(APPEND "${DEFINITIONS_FILE}"  "// set notype's code with the last possible Type code, which is\n")
            FILE(APPEND "${DEFINITIONS_FILE}"  "//    ((1 << (2 * sizeof(Type))) - 1) == 65535\n")
            FILE(APPEND "${DEFINITIONS_FILE}"  "// as Type == unsigned short int\n")
            FILE(APPEND "${DEFINITIONS_FILE}"  "const opencog::Type opencog::${TYPE}=((1 << (8 * sizeof(Type))) - 1);\n")
