...
# The following is for symlinking to the build directory
# FIXME: It doesn't create the symlink consistently. For example, if the
# the symlinks created are removed from the symlink directory
# (build/opencog/scm) then running `make build` will not recreate the
# symlink as the OPENCOG_ADD_ATOM_TYPES macro isn't rerun if the OUTPUT
# files are already  found in the build directory.
#
# Options tested:
# * Adding a dummy output will ensure the macro is rerun during every build,
#   but the penality is the time for recompiling the autogenerated c++ code
#   and any other dependencies.
INCLUDE("${PROJECT_SRC_DIR}/lib/OpenCogFunctions.cmake")
PROCESS_GUILE_PATH(${PROJECT_BUILD_DIR} ${PROJECT_CURRENT_BUILD_DIR}
    ${PROJECT_BUILD_DIR} ${SCM_FILE_NAME})
