...
SET(NAMESERVER_REFERENCE "opencog::nameserver().")
SET(NAMESERVER_INSTANCE "opencog::nameserver()")

FILE(WRITE "${HEADER_FILE}" "/* File automatically generated by the macro OPENCOG_ADD_ATOM_TYPES. Do not edit */\n")
FILE(APPEND "${HEADER_FILE}"  "#include <opencog/atoms/proto/types.h>\nnamespace opencog\n{\n")
...
FILE(APPEND "${INHERITANCE_FILE}" "${NAMESERVER_INSTANCE};\n")
    ...
    IF (MATCHED AND CMAKE_MATCH_1)
        ...
        IF (PARENT_TYPES)
            ...
            FOREACH (PARENT_TYPE ${PARENT_TYPES})
                ...
                IF (NOT "${TYPE}" STREQUAL "NOTYPE")
                    FILE(APPEND "${INHERITANCE_FILE}" "opencog::${TYPE} = ${NAMESERVER_REFERENCE}declType(opencog::${PARENT_TYPE}, \"${TYPE_NAME}\");\n")
                ENDIF (NOT "${TYPE}" STREQUAL "NOTYPE")
            ENDFOREACH (PARENT_TYPE)
        ELSE (PARENT_TYPES)
            IF (NOT "${TYPE}" STREQUAL "NOTYPE")
                FILE(APPEND "${INHERITANCE_FILE}" "opencog::${TYPE} = ${NAMESERVER_REFERENCE}declType(opencog::${TYPE}, \"${TYPE_NAME}\");\n")
            ENDIF (NOT "${TYPE}" STREQUAL "NOTYPE")
        ENDIF (PARENT_TYPES)
