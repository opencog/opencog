from examples.python.conceptual_blending.networks.debate_with_kant.debate_with_kant import \
    DebateWithKantNetwork
from examples.python.conceptual_blending.networks.paul_sally.paul_sally import \
    PaulSallyNetwork
