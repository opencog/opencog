...
(add-to-load-path ".")
(load-from-path "john-is-a-man-r2l-output.scm")
(load-from-path "men-breathe-air-r2l-output.scm")

;; Load PLN rules
(add-to-load-path "../../../opencog/pln/rules")
(load-from-path "deduction-rule.scm")
(load-from-path "abduction-rule.scm")
(load-from-path "implication-instantiation-rule.scm")
