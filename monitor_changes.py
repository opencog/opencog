...
#    print [str(latest_time), str(previous_time)]
    ...
    eval_has_dramatic_changes = atomspace.add_edge(t.EvaluationLink, [pred_has_dramatic_changes])
    ...
    for change_with_tv in changes_with_tv:        
        list_link = atomspace.add_edge(t.ListLink, change_with_tv)
        eval_link = atomspace.add_edge(t.ReferenceLink, [pred_change_with_tv, list_link])
#        print eval_link

    if changes_with_arg: 
        list_link = atomspace.add_edge(t.ListLink, changes_with_arg)
        eval_link = atomspace.add_edge(t.ReferenceLink, [pred_change_with_arg, list_link])
#        print eval_link
